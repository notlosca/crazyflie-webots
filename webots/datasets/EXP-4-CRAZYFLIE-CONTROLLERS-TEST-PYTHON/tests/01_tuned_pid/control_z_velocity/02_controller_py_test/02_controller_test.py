...
if __name__ == '__main__':
    ...
    first_task = False
    first_task_info = {'setpoints': {'velocity.x':0.1, 'velocity.y':.1, 'velocity.z':.0, 'attitudeRate.yaw':0.0}, 'num_steps':1000}
    first_task_step = 0
    ...
    folder = parent_folder +'/tests/01_original_pid/control_z_velocity'+ '/02_controller_py_test'
