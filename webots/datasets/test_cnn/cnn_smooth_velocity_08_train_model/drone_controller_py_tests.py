...
if collect_data:
    ...
    parent_folder = '../../datasets/test_cnn/'
    folder = parent_folder+ 'cnn_smooth_velocity_08_train_model'
...
if __name__ == '__main__':
    ...
    filename = '/home/losca/Documents/University/Thesis/scarciglia-nanodrone-gate-detection/PyTorch/Models/160x32/08_train/Frontnet.pt' # 03_train validation w/o lights, 02 w/ lights
