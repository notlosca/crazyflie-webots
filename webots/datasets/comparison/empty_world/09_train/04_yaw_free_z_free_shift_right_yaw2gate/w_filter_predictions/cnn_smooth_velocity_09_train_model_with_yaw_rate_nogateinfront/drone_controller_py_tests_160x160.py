...
if collect_data:
    ...
    parent_folder = '../../datasets/comparison/empty_world/09_train/04_yaw_free_z_free_shift_right_yaw2gate/w_filter_predictions/'
    folder = parent_folder+ f'cnn_smooth_velocity_{nn_model}_model_with_yaw_rate_gateinfront'
...
if __name__ == '__main__':
    ...
    take_off = True
    take_off_info = {'setpoints': {'velocity.x':0.0, 'velocity.y':0.0, 'position.z':0.5, 'attitudeRate.yaw':0.0}}
    ...
    detections = []
    GT_detections = []
    # filter = {'alpha':0.1, 'order':1} # put before 
    vs_counter = 0
    ...
    filename = f'/home/losca/Documents/University/Thesis/scarciglia-nanodrone-gate-detection/PyTorch/Models/160x32/{nn_model}/Frontnet.pt' # 03_train validation w/o lights, 02 w/ lights
