...
if collect_data:
    ...
    parent_folder = '../../datasets/comparison/empty_world/'
    folder = parent_folder+ 'cnn_smooth_velocity_07_train_model_with_yaw_rate'
...
if __name__ == '__main__':
    ...
    filename = '/home/losca/Documents/University/Thesis/scarciglia-nanodrone-gate-detection/PyTorch/Models/160x32/07_train/Frontnet.pt' # 03_train validation w/o lights, 02 w/ lights
