...
if __name__ == '__main__':
    ...
    while testrun < 10:
        if collect_data:
            ...
            parent_folder = '../../datasets/IBVS-MULTIPLE-RUNS/empty_bg/'
            folder = parent_folder+ f'CV/run_{testrun}_100px_error/'
            ...
            try:
                ...
                if e.errno != errno.EEXIST:
                    ...
                    print(f"Overwriting laboratoryfolder {imgs_folder}")
        ...
        dataset['ibvs'] = {'lambda': lmda, 'threshold': thresh, 'Z':{'estimated':False, 'value':Z}, 'smooth_start':smooth_start, 'median_err_thresh':median_err_thresh}
        ...
        while robot.step(timestep) != -1:
            ...
            if take_off:
                ...
                current_p_detected, drawing = corner.detect_corners(img, blur_kernel=(7,7), canny_thresh=(100,200), retr_method='external', method_corner_retr='highest', return_drawing=True)
