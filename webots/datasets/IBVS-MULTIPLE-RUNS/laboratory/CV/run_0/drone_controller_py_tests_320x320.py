...
if __name__ == '__main__':
    ...
    while robot.step(timestep) != -1:
        ...
        if take_off:
            ...
            current_p_detected, drawing = corner.detect_corners(img, blur_kernel=(3,3), canny_thresh=(50,150), retr_method='external', method_corner_retr='highest', return_drawing=True)
