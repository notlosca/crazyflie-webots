...
# n_samples = 25000 # Train
n_samples = 10000 # Valid
...
exp_folder = f"../../datasets/simulation_datasets/{exp_name}-{n_samples}_samples-valid"
...
if __name__ == '__main__':
    ...
    translation_gate = robot.getFromDef("GATE").getField('translation').getSFVec3f()
    ...
    gate_rot = robot.getFromDef("GATE").getField('rotation').getSFRotation()
    ...
    while robot.step(timestep) != -1 and frame_n < n_samples:
        ...
        # print('[gate_rot] = getSFRotation', gate_rot)
        ...
        if rotate_gate:
            if it_idx % rotate_gate_every == 0 and frame_n != 0:
                ...
                # print('[rotate_gate_every] = setSFRotation', gate_yaw, ax_angle)
        ...
        #                 shape1.getField('appearance').getSFNode().getField('baseColorMap').getSFNode().getField('url').setMFString(0, f'textures/textured_panel_3m/laboratory/{imgs[random_img_id]}')
        ...
        # if frame_n == random_background_after:
