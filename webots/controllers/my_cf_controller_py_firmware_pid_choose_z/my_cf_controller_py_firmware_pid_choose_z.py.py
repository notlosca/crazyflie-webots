...
import sys
import os
print(os.listdir('../../../../crazyflie-firmware/build'))
...
#starting_yaw = 0
starting_roll, starting_pitch, starting_yaw = imu.getRollPitchYaw()
print(starting_yaw)
cnt = 0
print('Take off!')
...
while robot.step(timestep) != -1:
    ...
    print('yaw', yaw, 'starting_yaw', starting_yaw)
    ...
    cmd_yaw = -radians(control.yaw)# + starting_yaw
    cmd_thrust = control.thrust

    print(f'cmd_roll {cmd_roll:.4f}')
    print(f'cmd_pitch {cmd_pitch:.4f}')
    print(f'cmd_yaw {cmd_yaw:.4f}')
    print(f'cmd_thrust {cmd_thrust:.4f}')
