...
if collect_data:
    ...
    folder = parent_folder+ f'Dummy/run_{testrun}/'
...
if __name__ == '__main__':
    ...
    while robot.step(timestep) != -1:
        ...
        if take_off:
            ...
            current_p_detected = np.array([[123.83658294, 123.23511773, 196.07074137, 195.39466865],
                                           [102.23886123, 188.21779395, 187.9286492 , 102.11171375]])
